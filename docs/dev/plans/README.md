...
| [approval 对象化（Spec 3）](2026-09-22-approval-objectification-spec.md) | B2 / D23 | ADR-0020 | **M4 施工完成（PR1–PR2，含 PR3 服务层预落地，用户裁决登记于 §8），S8 review 🟢**；**v0.7 定向核对 🟢，PR3–PR4（M5）可动工**（S8 红队复核 §1.3–§1.6 的 5🟡 + 10🔵 与 R7-1 修正已并入 §1.7） |
