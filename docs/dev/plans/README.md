...
| [approval 对象化（Spec 3）](2026-09-22-approval-objectification-spec.md) | B2 / D23 | ADR-0020 | **M4 施工完成（PR1–PR2，含 PR3 服务层预落地，用户裁决登记于 §8），S8 review 🟢**；**PR3 阻塞于 v0.7 修订**（S8 红队定向复核 §1.3–§1.6 结论 🟡：5🟡 + 10🔵 待修订后定向核对） |
