...
| D23 | 已定案，v2 推进中 | 配音顺听（工序 B）人机摩擦力大，缺终端流式连播与原地纠偏工作台 | `pipeline/tts.py` | 四阶段工序卡, ADR-0006, ADR-0016, v2架构方案 | 定案为 IndexTTS2 情感/时长控制（云端 30 秒出全片）+ 03.5/05 三十秒结构化打点（v2架构方案二.3/三节） |
