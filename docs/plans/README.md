...
| [v2 云端 GPU 重构](2026-09-08-v2-cloud-gpu-reconstruction.md) | B1, B2, D1, D2, D4, D5, D6, D22, D23, D25 | ADR-0014, ADR-0003, ADR-0005, ADR-0006 | **全局收束施工图**，待三部曲收官后动工 |
| [v2 系统架构设计](2026-09-10-v2-architecture-design.md) | B1, B2, B3, D1, D2, D4, D5, D6, D22, D23, D24, D25 | ADR-0014, ADR-0003, ADR-0004, ADR-0005, ADR-0006, ADR-0008, ADR-0010~0013 | v2 施工图的架构落地层（7 大子系统设计），**待人类总监确认后动工**；含对上位施工图的三处修正（见文末附录） |
| [M2b 服务对象修正：番剧域 → 素材池](2026-09-11-m2b-pool-scope.md) | D4 / D5 / D6 / B1 | ADR-0015, ADR-0003, ADR-0008, ADR-0016 | **待 M2b 施工 session 执行**：六条裁决（判据改实拍、SP 键已核实零改动、门槛按池平铺、逐池标定、显式触发、clips 零分支） |
